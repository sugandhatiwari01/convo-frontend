...
app.get('/auth/google/callback',
  ...
  (req, res) => {
    ...
    // Redirect to frontend with token and username in query params
    res.redirect(`https://convo-frontend.vercel.app/?token=${token}&username=${encodeURIComponent(req.user.username)}`);
  }
);
